export default function FootBar() {
    return (
        <>
            {/* spacer para reservar espaço quando o footer estiver fixed em telas maiores */}
            <div aria-hidden="true" className="h-24 md:h-24" />

            <footer className="md:fixed w-full bg-white text-[#211181] py-4 bottom-0 left-0 border-t border-gray-200 shadow-md">
